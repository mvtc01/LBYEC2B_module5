...
class UnitExRunner(object):
    ...
    def __init__(self, filename, pathdir=None, file_ext="c"):
    ...
    def compile(self):
        ...
        subprocess.run([self.opts[self.file_ext]['compiler'],"-std="+self.opts[self.file_ext]['standard'],"-lm","-ggdb",self.full_input,"-o",self.full_output])
